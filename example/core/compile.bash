...
BUILD_DIR="./build"
MICROKIT_BOARD="odroidc4_4_cores"
...
make BUILD_DIR=$BUILD_DIR MICROKIT_BOARD=$MICROKIT_BOARD MICROKIT_SDK=$MICROKIT_SDK MICROKIT_CONFIG=$MICROKIT_CONFIG NUM_CPUS=$NUM_CPUS -B